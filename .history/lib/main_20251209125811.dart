...
void main() async {
  ...
  try {
    ...
    if (kIsWeb && options == null) {
      // On web, FirebaseOptions must be provided. Provide a helpful
      // message and allow the app to run in a degraded mode.
      // ignore: avoid_print
      print('Firebase web config missing. Run `flutterfire configure` to generate firebase_options.dart.');
