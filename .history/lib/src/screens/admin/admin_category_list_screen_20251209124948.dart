...
class _AdminCategoryListScreenState extends State<AdminCategoryListScreen> {
  ...
  void initState() {
    super.initState();
    // Check Firebase initialization. If not initialized (e.g., no
    // firebase_options configured for web), show a helpful message
    // instead of crashing.
    ...
    final dataSource = FirebaseCategoryDataSource(firestore);
